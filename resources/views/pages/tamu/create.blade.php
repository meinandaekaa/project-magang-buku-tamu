...
<div 
    ...
    class="max-w-3xl mx-auto p-6 bg-white shadow rounded"
>
    ...
    <form action="{{ route('tamu.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div>
         ...
         <div>
            <label for="jam_kepulangan" class="block font-medium mb-1">Jam Kepulangan</label>
            <input type="time" id="jam_kepulangan" name="jam_kepulangan" value="{{ old('jam_kepulangan') }}"
                class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400">
        </div>
        ...
        <!-- Upload Foto -->
        <div>
            <label for="foto" class="block font-medium mb-1">Foto KTP</label>
            <input type="file" id="foto" name="foto"
                accept="image/*"
                class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400">
            <small class="text-gray-500">Format JPG/PNG, opsional</small>
        </div>

                <!-- ================= ANGGOTA YANG IKUT BERKUNJUNG ================= -->
        <div x-data="{ anggota: [{ nama: '', nik: '' }] }" class="mt-6">
            <h2 class="text-lg font-semibold mb-3">Anggota yang Ikut Berkunjung</h2>
            ...
            <template x-for="(item, index) in anggota" :key="index">
                <div class="border p-4 rounded mb-4">
                    ...
                    <div>
                        <label class="block mb-1">NIK / NIP</label>
                        <input type="text"
